...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("room", function (a) {
            $("#room_public")[a.isPublic ? "show" : "hide"](), $("#room_private")[a.isPublic ? "hide" : "show"](), $(".room_id").text(a.room);
        }),
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]
                            this.stopSpeaking(),
                            (this.goingToSpeak = !0),
                            speak.play(
                                b,
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["purple","peedy","clippy","genie","merlin",], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziPurple","peedy","clippy","genie","merlin","topjej"];
...
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("loginFail", function (a) {
            var b = { full: "Room is full.", nameMal: "Nice try. Why would anyone join a room named that anyway?" };
            $("#login_card").show(),
                $("#login_load").hide(),
                $("#login_error")
                    .show()
